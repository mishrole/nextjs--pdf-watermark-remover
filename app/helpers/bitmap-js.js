// @ericandrewlewis/bitmap
import fs from "fs";

export function padImageData({ unpaddedImageData, width, height }) {
...
export function bitmapFileHeader({
  filesize = 0,
  applicationHeader = 0,
  imageDataOffset = 0
}) {
...
export function readBitmapFileHeader(filedata) {
  return {
...
export function readDibHeader(filedata) {
...
export function readColorTable(filedata) {
...
export function readBitmapFile(file) {
  return new Promise((resolve, reject) => {
